...
\begin{picture}
    (0,0)
    \put(-66,206){\makebox(0,0)[rt]{\includegraphics[width=4cm]{../../resources/Haw_logo.png}}}
    \put(174,200){\makebox(0,0)[rt]{\includegraphics[width=5cm]{../../resources/Hanseaticsoft_logo.png}}}
\end{picture}
}
...
\begin{document}
    ...
    \begin{picture}
        (0,0)
        \put(0,0){\makebox(320,-50)[rt]{\includegraphics[width=4cm]{../../resources/Lloyds_logo.png}}}
    \end{picture}
    \begin{itemize}
    ...
    \begin{picture}
        (0,0)
        \put(333,64){\makebox(0,0)[rt]{\includegraphics[width=12.6cm]{../../resources/solutions.PNG}}}
    \end{picture}
    }
