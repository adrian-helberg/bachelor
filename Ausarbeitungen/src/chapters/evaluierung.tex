...
\begin{figure}[H]
    \centering
    \includegraphics[width=16cm]{../images/compressed_tree.png}
...
Führt man das generalisierte L-System aus, ergeben sich die Ähnlichkeitsstrukturen (8 Ausführungsiterationen
pro generierter Struktur bei 30 Strukturen).

\subsection*{Synthese}
Das generalisierte L-System wird in einer Anzahl Iterationen, die vom Benutzer festgelegt wird,
ausgeführt und visualisiert:
...
Folgende Tabelle zeigt die Wahl der Gewichtungsparameter und gibt das jeweilige Beispiel an:
\begin{figure}[H]
    \centering
    \begin{tabular}{|l|c|c|}\hline
    \diagbox[width=10em]{$w_0$}{$w_l$} & Niedrig & Hoch \\ \hline
