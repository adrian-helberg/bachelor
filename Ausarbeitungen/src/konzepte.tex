...
%    \newpage
%
%    \underline{Algorithmus 2 ausgeschrieben}:\\~\\
...
%        \item[3.] Knoten $\beta=$ nächster Knoten*
...
%            \begin{itemize}
%                \item[] Ersetze Symbol mit neuem Symbol, das nicht in $M$ enthalten ist und füge es $M$ hinzu
%            \end{itemize}
